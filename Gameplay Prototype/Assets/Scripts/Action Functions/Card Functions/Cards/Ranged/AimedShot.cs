...
public class AimedShot : Card
{
    ...
    public override void castCard(CharacterBehaviour cb = null)
    {
        ...
        CharacterBehaviour t = CharacterBehaviour.getHighestHP(CharacterBehaviour.getAllEnemies());
        for (int i = 0; i < r; i++)
        {
            t = CharacterBehaviour.getHighestHP(CharacterBehaviour.getAllEnemies());
            t.TakeDamage(d);
        }
