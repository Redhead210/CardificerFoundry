...
public class BattleManager : MonoBehaviour
{
    ...
    public enum Effects { Slash, Block, Regen, Toxin, Punch, Taunt, Power, Bullet, Mark, Frost, Blast, Fire, Blood, Smoke, Cogs, Light, Radience};
    ...
    {
        if(GameManager.act == 3)
        {
            GameManager.inCardificerFight = true;
        }
        battleEnded = false;
    ...
    public void EndOfTurn()
    {
        ...
        foreach (CharacterBehaviour c in CharacterBehaviour.getAllAlive())
        {
            ...
            if (c.thisChar.hp > 0 && c.HasEffect("burn"))
            {
                ...
                c.SubtractEffect("burn", Mathf.Max(1,Mathf.RoundToInt(c.EffectStacks("burn")/2)));
            }
